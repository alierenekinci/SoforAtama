      ...
      <div class="col-12" v-else>
        ...
        <table>
          <tr>
            ...
            <th>Cinsiyet</th>
            <th>
              <button class="btn white right" @click="driverStore.yukle()">
          ...
          <tr v-for="driver in driverStore.drivers">
            ...
            <td class="right">
              <button class="btn" @click="driverStore.selectedDriver=driver">
                <font-awesome-icon icon="fa-solid fa-pen-to-square"/>
                Düzenle
              </button>
              /
              <button class="btn red" @click="deleteDriver(driver)">
